...
#
    ...
    def llenarTabla(self):
        try:
            ...
            for producto in productos:
                ...
                self.tableWidget.setRowHeight(fila,50)
                ...
                self.tableWidget.setCellWidget(fila,0,self.botonesEditarEliminar(producto_id,producto,fila))
                self.tableWidget.setColumnWidth(0,85)
                
                self.tableWidget.setItem(fila,1,QTableWidgetItem(producto_id))
                self.tableWidget.setColumnWidth(1,150)
                
                self.tableWidget.setItem(fila,2,QTableWidgetItem(nombre))
                self.tableWidget.setColumnWidth(2,270)
                
                self.tableWidget.setItem(fila,3,QTableWidgetItem(str(stock)))
                self.tableWidget.setColumnWidth(3,70)

                self.tableWidget.setItem(fila,4,QTableWidgetItem(str(precio)))
                self.tableWidget.setColumnWidth(4,100)
                
                self.tableWidget.setItem(fila,5,QTableWidgetItem(str(iva)))
                self.tableWidget.setColumnWidth(5,60)
                
                self.tableWidget.setItem(fila,6,QTableWidgetItem(str(coste)))
    ...
    def botonesEditarEliminar(self,producto_id,productos,fila):
        ...
        self.btn_eliminarProducto.clicked.connect(lambda checked, producto_id=producto_id, productos=[productos]: self.eliminarCliente(producto_id,productos))

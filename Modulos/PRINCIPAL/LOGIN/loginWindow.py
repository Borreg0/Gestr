...
class LoginWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.loginCampos.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.logo.setPixmap(QPixmap(u"Modulos/WEB/imagenes/gestr.ico"))
        ...
        for empleado in empleados:
            ...
            if empleado["email"] == email:
                ...
                if bcrypt.checkpw(contrasena.encode('utf-8'), hash_bbdd):
                    ...
                    QMessageBox.information(self,"Credenciales incorrectas","Email o contraseña incorrecto 1",QMessageBox.Ok)

...
from usuarios.categorias import usuario

#importar widgets y pages
from gui.pages.ui_pages import *
...
class UI_MainWindow(object):
    ...
    def setup_ui(self,parent):
        ...
        #ETIQUETA DE VERSION
        self.menu_izquierdo_version = QLabel("v1.6.1")
        ...
        #Label derecha
        #
        self.lblsuperior_der_nombre_pagina = QLabel("| SGE")
    ...
    def permisos(self):
        ...
        if len(usuario)>0:
            ...
            if usuario[0]["rol"] == "Admin":
                #el toggle button ya se añade antes de iniciar la funcion, igual que web y
                #ajustes porque son modulos comunes a todos los roles
                #self.menu_izquierdo_marco_superior_layout.addWidget(self.toggle_button)
                ...
                self.menu_izquierdo_marco_superior_layout.addWidget(self.btn6)#inventario
                self.menu_izquierdo_marco_superior_layout.addWidget(self.btn9)#tpv
                #self.menu_izquierdo_marco_superior_layout.addWidget(self.btn10)#fabricacion
                #self.menu_izquierdo_marco_superior_layout.addWidget(self.btn7)#mantenimiento

    ...
    def llenarTabla(self):
        ...
        try:
            ...
            for cliente in clientes:
                ...
                self.tableWidget.setCellWidget(fila,0,self.botonesEditarEliminar(cliente_id,cliente,fila))
                self.tableWidget.setColumnWidth(0,85)
                
                #datos cliente
                #self.tableWidget.setItem(fila,1,QTableWidgetItem(str(cliente_id)))
                
                self.tableWidget.setItem(fila,1,QTableWidgetItem(nombre))
                self.tableWidget.setColumnWidth(1,180)
                
                self.tableWidget.setItem(fila,2,QTableWidgetItem(email))
                self.tableWidget.setColumnWidth(2,270)
                
                self.tableWidget.setItem(fila,3,QTableWidgetItem(telefono))
                self.tableWidget.setColumnWidth(3,150)

                self.tableWidget.setItem(fila,4,QTableWidgetItem(pais))
                self.tableWidget.setColumnWidth(4,150)
                
                self.tableWidget.setItem(fila,5,QTableWidgetItem(registro))

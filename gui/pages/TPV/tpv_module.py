...
class Tpv_page(QWidget):
    def __init__(self, productos_page = None , parent = None):
        ...
        #FRAME CENTRO
        self.frameRadioButtons = QFrame(self.frameCentro)
        self.frameRadioButtons.setStyleSheet("font:530 18px;")
        ...
        #si se activa el otro rbutton esto se debe desactivar
        ...
        self.verticalLayoutFrameCentro.addWidget(self.frameRadioButtons)
        self.verticalLayoutFrameCentro.addWidget(self.elegirCliente)
        self.verticalLayoutFrameCentro.addWidget(self.elegirProducto)
        self.verticalLayoutFrameCentro.addWidget(self.frameStockCantidad)
        self.verticalLayoutFrameCentro.addWidget(self.modoDePago)
